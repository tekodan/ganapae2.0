...
import com.example.root.ganapae20.data.data.addeditAlerta.AddEditAlertaFragment;
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    ...
                    AddEditAlertaFragment addeditalertaactivity= new AddEditAlertaFragment();
                    return addeditalertaactivity;
                case 1:
